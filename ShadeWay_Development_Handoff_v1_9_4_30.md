...
**프로젝트명:** ShadeWay  
**현재 안정 기준:** `ShadeWay_MVP_v1_9_4_30_Cloudflare_Production_Deploy.html`  
**문서 기준 버전:** `v1.9.4.30 Cloudflare Production Deploy · Shade Graph Beta · GitHub + Workers`  
**최종 업데이트:** 2026-08-09  
...
- 프로젝트 목표와 차별점
- 초기 v0.1부터 최신 v1.9.4.30까지 개발 흐름
- 현재 구현된 전체 기능
- 현재 기술 구조
- 그림자 계산 방식
- 건물 높이 추정 방식
...
향후 패치는 **v1.9.4.30을 기준으로 누적 개발**하며, 이전 버전으로 롤백하면서 최신 기능을 잃지 않는다.
...
```text
ShadeWay_MVP_v1_9_4_30_Cloudflare_Production_Deploy.html
```
...
```text
ShadeWay_MVP_v1_9_4_30_Cloudflare_Production_Deploy.html
ShadeWay_Development_Handoff_v1_9_4_30.md
ShadeWay_v1_9_4_30_Cloudflare_Production_Deploy.zip
```
